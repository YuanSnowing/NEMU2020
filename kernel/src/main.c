...
#ifdef IA32_PAGE
	// x = 1;
	/* We must set up kernel virtual memory 
	 * first because our kernel thinks it 
	 * is located at 0xc0100000, which is 
	 * set by the linking options in Makefile.
	 * Before setting up correct paging,
